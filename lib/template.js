module.exports = {
    ...
    page:function(content, title, page) {
      return `
        ...
        <ul class="filter">
          <li><a href="/page/${page}/filter/서울">서울</a></li>
          <li><a href="/page/${page}/filter/경기">경기</a></li>
          <li><a href="/page/${page}/filter/인천">인천</a></li>
          <li><a href="/page/${page}/filter/강원">강원</a></li>
          <li><a href="/page/${page}/filter/충남">충남</a></li>
          <li><a href="/page/${page}/filter/충북">충북</a></li>
          <li><a href="/page/${page}/filter/전남">전남</a></li>
          <li><a href="/page/${page}/filter/전북">전북</a></li>
          <li><a href="/page/${page}/filter/경남">경남</a></li>
          <li><a href="/page/${page}/filter/경북">경북</a></li>
          <li><a href="/page/${page}/filter/제주">제주</a></li>
        </ul>
        <br>
