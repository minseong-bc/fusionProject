module.exports = {
    ...
    content:function(contents, page){
      var contentAry = [];
      var mainlist = '<div class="swiper-wrapper">';
      var i = 0;
      while(contents[i].Id < contents[i+1].Id){
        mainlist = mainlist + `
      ...
      mainlist = mainlist+'</div>';
      contentAry.push(mainlist);
      var sublist = '<div class="swiper-wrapper">';
