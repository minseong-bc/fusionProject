module.exports = {
    ...
    detail:function(topics){
      ...
      <div class="content">
          <div class="contentimg">
              <img src="${topics[0].firstimage}" class="contentimg">
          </div>
          <div class="content-details">
              <h2 class="contenttit">${topics[0].title}</h2>
              <p class="content-address">${topics[0].addr1}</p>
    ...
    content:function(contents, sequence='main', page='main'){
      if (sequence === 'main')  {
          ...
          list = list + `
            <div class="swiper-slide">
              <div class="slide-content">
                <a href=/page/${page}/${contents[i].Id}><img src="${contents[i].firstimage}" width="300px" height="200px" class="slide"></a>
                <a href=/page/${page}/${contents[i].Id}><p class="content-title">${contents[i].title}</p></a>
                <a href=/page/${page}/${contents[i].Id}><p class="content-info">${contents[i].detail}</p></a>
              </div>
            </div>
          `;
          i = i + 1;
        ...
        while(i < 20){
          list = list + `
            <div class="swiper-slide">
              <div class="slide-content">
                <a href=/page/${contents[i].Id}><img src="${contents[i].firstimage}" width="300px" height="200px" class="slide"></a>
                <a href=/page/${contents[i].Id}><p class="content-title">${contents[i].title}</p></a>
                <a href=/page/${contents[i].Id}><p class="content-info">${contents[i].detail}</p></a>
              </div>
            </div>
          `;
          i = i + 1;
