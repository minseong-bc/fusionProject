module.exports = {
    ...
    content:function(contents, sequence){
      if (sequence === 'main')  {
        var list = '<div class="swiper-wrapper">';
        var i = 0;
        while(i < contents.length/2){
          list = list + `
            <div class="swiper-slide"><div class="slide-content">
              <a href=/page/detail><img src="${contents[i].firstimage}" width="300px" height="200px" class="slide"></a>
              <a href=/page/detail><p class="content-title">${contents[i].title}</p></a>
              <a href=/page/detail><p class="content-info">${contents[i].detail}</p></a>
            </div></div>
          `;
          list = list+'</div>';
          i = i + 1;
        ...
        while(i < contents.length){
          list = list + `
            <div class="swiper-slide"><div class="slide-content">
              <a href=/page/${contents[i]}><img src="${contents[i].firstimage}" width="300px" height="200px" class="slide"></a>
              <a href=/page/${contents[i]}><p class="content-title">${contents[i].title}</p></a>
              <a href=/page/${contents[i]}><p class="content-info">${contents[i].detail}</p></a>
            </div></div>
          `;
          list = list+'</div>';
          i = i + 1;
