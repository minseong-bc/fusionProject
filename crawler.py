...
query = "INSERT INTO gilbut.event (addr1, title, firstimage, detail) VALUES (%s, %s, %s, %s);"
...
elem = wait.until(EC.presence_of_element_located((By.CSS_SELECTOR, '#wrap > section > article.art1 > div > div.art1-layout > div.layout > ul > li:nth-child(3) > a')))
time.sleep(1)
